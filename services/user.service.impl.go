...
// db.collections.find({name: "dunky"})
...
func (u *UserServiceImpl) UpdateUser(user *models.User) error {
	...
	update := bson.D{bson.E{Key: "$set", Value: bson.D{bson.E{Key: "user_name", Value: user.Name}, 
	bson.E{Key: "user_age", Value: user.Age}, bson.E{Key: "user_address", Value: user.Address}}}}
